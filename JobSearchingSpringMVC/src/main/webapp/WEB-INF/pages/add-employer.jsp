...
<div class="container">
    <c:if test="${employer.id == 0}">
        <h1 class="text-center dark-color">THÊM THÔNG TIN NHÀ TUYỂN DỤNG</h1>
    </c:if>
    <c:if test="${employer.id > 0}">
        <h1 class="text-center dark-color">CHỈNH SỬA THÔNG TIN NHÀ TUYỂN DỤNG</h1>
    </c:if>
    ...
    <form:form action="${action}" method="post"
               modelAttribute="employer" cssClass="mt-4">
        ...
        <div class="form-group">
            ...
            <form:textarea path="majoring" class="form-control"/>
        </div>
        <c:if test="${employer.id == 0}">
            <div class="form-group">
