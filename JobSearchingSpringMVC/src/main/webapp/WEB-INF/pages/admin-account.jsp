...
<div class="container">
    ...
    <section class="d-flex justify-content-center">
        <form class="mt-3 w-50" action="javascript:void(0)">
            ...
            <button type="submit" class="btn btn-info" onclick="loadUserAccount()">Tra cứu</button>
...
<%--                            </a>--%>
<%--                            <a style="margin-right: 10px"--%>
<%--                               href="<c:url value="/admin/account/add-or-update" />?id=${u.id}"--%>
<%--                               data-toggle="tooltip" title="Sửa">--%>
<%--                                <i class="fa-solid fa-pen"></i>--%>
<%--                            </a>--%>
<%--                            <a style="margin-right: 10px"--%>
<%--                               href="<c:url value="/admin/account/delete" />?id=${u.id}" class="confirmation"--%>
<%--                               title="Xoá">--%>
<%--                                <i class="fa-solid fa-trash"></i>--%>
<%--                            </a>--%>
<%--                            <c:if test="${u.userType.equals('ROLE_UV')}">--%>
...
<script>
    ...
    window.onload = (event) => {
        loadUserAccount(1, ${userService.maxItemsInPage})
    };
